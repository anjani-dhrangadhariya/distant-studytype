...
def loadEBMPICO(train_dir, outdir, candgen_version, write_to_file):
    ...
    if 'val' in outdir:
        filename = 'val_studytype.json'
        write_file = 'val_studytype_tui_pio3.tsv'
    if 'test_ebm_st_corr' in outdir:
        filename = 'test_ebm_st_corr.json'
        write_file = 'test_ebm_st_corr_tui_pio3.tsv'
